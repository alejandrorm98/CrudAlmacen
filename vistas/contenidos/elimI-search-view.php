<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ITEM ELIMINADO
    </h3>
...
<div class="container-fluid">
    <?php 
                ...
                if ((isset($_SESSION['producto']) && isset($_SESSION['proveedor'])) ) {
                    echo $lis->paginar_elimiI_controlador($pagina[1],10,$pagina[0],"",$_SESSION['producto'],$_SESSION['proveedor']);
                }else{
                    echo $lis->paginar_elimiI_controlador($pagina[1],10,$pagina[0],"","","");
                }
...
<div class="container-fluid">
    <?php 
        require_once "./controladores/elimiControlador.php";
        $lis = new elimiControlador();
        echo $lis->paginar_elimiI_controlador($pagina[1],15,$pagina[0],$_SESSION['busqueda'],$_SESSION['producto'],$_SESSION['proveedor']);
